...
## 四、完整 Eval 结果 (best.pt = epoch 73)

> Eval 时间: 2026-05-21 18:28~18:54, 共 ~26 分钟
> 配置: single sample, num_steps=20, no physics guidance
...
| **Average** | | | **0.752** | **0.772** | **0.756** | **0.757** | 26m |

### 与 v1 和 RNADiffFold 对比
...
**结论**: v3 在 5/7 数据集上超越 v1，尤其在 OOD-hard 数据集 (PDB_TS1 +4.1%, PDB_TS_hard +3.8%) 上提升明显。仅 80 epochs 训练，继续训练有望进一步拉开差距。
