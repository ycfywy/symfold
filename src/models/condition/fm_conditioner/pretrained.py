...
def load_model_and_alphabet_local(model_location, theme="rna"):
    ...
    # PyTorch 2.6 changed torch.load default weights_only=True; RNA-FM checkpoint contains argparse.Namespace.
    ...
    try:
        ...
        regression_data = torch.load(regression_location, map_location='gpu', weights_only=False)
